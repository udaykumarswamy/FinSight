...
from finsight.schemas import Answer, IsDone, OptimizedToolArgs, Task, TaskList
from finsight.tools import TOOLS
from finsight.utils.logger import Logger
from finsight.utils.ui import show_progress
...
class Agent:
    ...
    def is_goal_achieved(self, query: str, task_outputs: list) -> bool:
        ...
        Data and results collected from finsight.tools so far:
        {all_results}
