...
DEFAULT_SYSTEM_PROMPT = """You are FinSight, an autonomous financial research agent. 
...
PLANNING_SYSTEM_PROMPT = """You are the planning component for FinSight, a financial research agent. 
...
ACTION_SYSTEM_PROMPT = """You are the execution component of FinSight, an autonomous financial research agent. 
...
TOOL_ARGS_SYSTEM_PROMPT = """You are the argument optimization component for FinSight, a financial research agent.
...
ANSWER_SYSTEM_PROMPT = """You are the answer generation component for FinSight, a financial research agent. 
